...
namespace BitnuaVideoPlayer
{
    ...
    public class MainViewModel : ViewModelBase
    {
        ...
        private readonly VideoMode m_VideoMode_Clip = new VideoMode("Clip", readOnly: true);
        private readonly VideoMode m_VideoMode_Youtube_Dance = new VideoMode("YouTube Dance", readOnly: true);
        private readonly VideoMode m_VideoMode_Youtube_Clip = new VideoMode("YouTube Clip", readOnly: true);
